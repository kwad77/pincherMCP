...
| **v0.80** | **Stable promotion.** Same binary as v0.79; new release channel only (Homebrew bump + Docker `latest`/`stable` tags). No new features or behavior changes between the v0.79 final and v0.80 tag — that's what STABLE means in pincher's release-channel scheme ([docs/release-channels.md](docs/release-channels.md)). | 🚧 in flight |
