...
| **v0.64** | Dashboard deferred triangulating panels ([#635](https://github.com/kwad77/pincher/issues/635)) + tool-description audit + Rust/Java AST + Python corpus validation. | 🚧 in flight |
