...
| **v0.24.0** | **Dashboard hardening.** Test foundation (E2E harness, HTML snapshot, mobile viewport) + API hardening (pagination, error envelope, ETA) + UX polish (per-tab error state, dark mode, keyboard shortcuts, empty-state CTA, 30+ items total). Tracking umbrella: [#519](https://github.com/kwad77/pincher/issues/519). | planned |
