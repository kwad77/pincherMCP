...
| **v0.66** | **Dashboard panel rendering + cross-file edge resolution for the long tail.** Render the v0.64 substrate (tool-call entropy, payload distribution, per-tier saved-percentage medians) on the dashboard ([#635](https://github.com/kwad77/pincher/issues/635)). TS receiver-type resolver ([#1177](https://github.com/kwad77/pincher/issues/1177)). Rust + Java AST extractors ([#1182](https://github.com/kwad77/pincher/issues/1182) / [#1183](https://github.com/kwad77/pincher/issues/1183)). | 🚧 in flight |
