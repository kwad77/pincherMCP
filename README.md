...
| **v0.16.0** | **Structural perf wins.** Closure tables for trace BFS, diff-encoded `context` responses, expanded pinchQL pushdown for boolean/numeric columns ([#403](https://github.com/kwad77/pincher/issues/403), [#412](https://github.com/kwad77/pincher/issues/412) follow-up). | 🚧 in flight |
