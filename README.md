...
| **v0.86** | **Measurement-driven perf fixes.** Acts on v0.85's observability data: extraction-phase DB-write serialization ([#1627](https://github.com/kwad77/pincher/issues/1627), the dominant 73% gap), READS over-emission 95%-drop rate ([#1622](https://github.com/kwad77/pincher/issues/1622)), Python AST subprocess overhead ([#1626](https://github.com/kwad77/pincher/issues/1626)), IMPORTS pending-edge dedupe at package granularity ([#1642](https://github.com/kwad77/pincher/issues/1642)), resolve passes' full-pool rebind on every watcher tick ([#1629](https://github.com/kwad77/pincher/issues/1629)). Plus polish from v0.85's dogfood probe ([#1643](https://github.com/kwad77/pincher/issues/1643) search exact-identifier wildcard fallthrough, [#1645](https://github.com/kwad77/pincher/issues/1645) BY TOOL render width, [#1646](https://github.com/kwad77/pincher/issues/1646) PreToolUse hook test-file exemption). | 🚧 in flight |
