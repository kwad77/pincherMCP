...
| **v0.28.0** | **Dashboard auto-refresh polish.** Auto-refresh indicator ([#545](https://github.com/kwad77/pincher/issues/545)), pause refresh when tab inactive ([#546](https://github.com/kwad77/pincher/issues/546)), dark-mode toggle ([#549](https://github.com/kwad77/pincher/issues/549)), projection banner guard ([#544](https://github.com/kwad77/pincher/issues/544)). Part of [#519](https://github.com/kwad77/pincher/issues/519). | 🚧 in flight |
