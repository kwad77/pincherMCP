...
| **v0.77** | **MCP notification surface slice.** `notifications/progress` for long-running tools ([#1080](https://github.com/kwad77/pincher/issues/1080)); `notifications/message` for extraction failures / slow queries / drift warnings ([#1085](https://github.com/kwad77/pincher/issues/1085) judgment call on signal-to-noise threshold); roots/list Phase 2 background auto-index + `_meta.auto_indexed` ([#1081](https://github.com/kwad77/pincher/issues/1081) Phase 2). | 🚧 in flight |
