...
| **v0.87** | **Phase 3 perf rolls: READS over-emission, Python AST subprocess, IMPORTS dedupe; FILE-I follow-up; integration docs.** Phase 3 perf items deferred from v0.86 ([#1622](https://github.com/kwad77/pincher/issues/1622), [#1626](https://github.com/kwad77/pincher/issues/1626), [#1642](https://github.com/kwad77/pincher/issues/1642)), Phase 4 incremental-tick perf ([#1629](https://github.com/kwad77/pincher/issues/1629), [#1611](https://github.com/kwad77/pincher/issues/1611)), memory-pressure watcher backoff ([#1572](https://github.com/kwad77/pincher/issues/1572)), and `rebuild_fts` auto-advisory ([#1612](https://github.com/kwad77/pincher/issues/1612)) all gated on v0.85 measurement data. | 🚧 in flight |
