...
| **v0.27.0** | **Dashboard search polish.** Search debouncing ([#547](https://github.com/kwad77/pincher/issues/547)), snippet highlighting ([#548](https://github.com/kwad77/pincher/issues/548)), sparkline tooltip ([#555](https://github.com/kwad77/pincher/issues/555)), show-more in long lists ([#533](https://github.com/kwad77/pincher/issues/533)). Part of [#519](https://github.com/kwad77/pincher/issues/519). | 🚧 in flight |
