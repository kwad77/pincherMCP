...
| **v0.69** | **Hardening release.** Coverage targets per #1164 ([#1164](https://github.com/kwad77/pincher/issues/1164)) — internal/ast/* per-extractor ≥70%, internal/cypher sustain ≥90%, internal/index ≥85%, total ≥87%. Contract tests for v0.61-v0.67 features. Remaining slices of #1260 distribution polish (Scoop manifest, signed binaries, doctor --fix, uninstall, upgrade-detect). Branch-aware index invalidation ([#1303](https://github.com/kwad77/pincher/issues/1303), #1261 §2). Sign-off for the v0.70 stable promotion. | 🚧 in flight |
