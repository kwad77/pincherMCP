...
| **v0.68** | **Heavy AST extractors + closure-tables-default-on measurement push.** The four genuinely-heavy items deferred from v0.67: Java AST extractor ([#1183](https://github.com/kwad77/pincher/issues/1183)), Rust AST extractor ([#1182](https://github.com/kwad77/pincher/issues/1182), partial impl-scoping shipped in v0.67), TypeScript receiver-type resolver ([#1177](https://github.com/kwad77/pincher/issues/1177)), closure-tables-default-on gated on the #639 10k-file measurement using v0.67's `cmd/tracelatencybench` ([#1162](https://github.com/kwad77/pincher/issues/1162)). | 🚧 in flight |
