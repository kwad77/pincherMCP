...
| **v0.75** | **Phase 3 docs completeness sweep + judgment-call MCP notifications.** Documentation-completeness review across `docs/integrations/`, `docs/migration/`, `docs/tutorials/`, GitHub Pages ([#1334](https://github.com/kwad77/pincher/issues/1334)); MCP `notifications/message` emission for extraction failures, slow queries, drift warnings ([#1085](https://github.com/kwad77/pincher/issues/1085) — judgment call on signal-to-noise threshold). | 🚧 in flight |
