...
| **v0.79** | **Phase 3 hardening + deferred dogfood drains.** MCP notification surface ([#1080](https://github.com/kwad77/pincher/issues/1080) progress + [#1085](https://github.com/kwad77/pincher/issues/1085) message); roots/list Phase 2 background auto-index + `_meta.auto_indexed` ([#1081](https://github.com/kwad77/pincher/issues/1081) Phase 2); Ansible USES_VAR persistence + watcher poll backoff paired ([#1479](https://github.com/kwad77/pincher/issues/1479) + [#1474](https://github.com/kwad77/pincher/issues/1474)); cross-comparator pricing harness ([#1298](https://github.com/kwad77/pincher/issues/1298)); multi-platform install validation ([#1337](https://github.com/kwad77/pincher/issues/1337)); v0.79 hardening + stability sweep ([#672](https://github.com/kwad77/pincher/issues/672)). | 🚧 in flight |
