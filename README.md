...
| **v0.63** | Stub-tier language audit ([#1161](https://github.com/kwad77/pincher/issues/1161)) + Rust/Java AST extractors carried from v0.62 ([#1182](https://github.com/kwad77/pincher/issues/1182) / [#1183](https://github.com/kwad77/pincher/issues/1183)) + Python real-corpus validation ([#1184](https://github.com/kwad77/pincher/issues/1184)) + TS receiver-type resolver ([#1177](https://github.com/kwad77/pincher/issues/1177)). | 🚧 in flight |
