...
| **v0.78** | **MCP notification surface + Ansible USES_VAR persistence regression.** `notifications/progress` for long-running tools ([#1080](https://github.com/kwad77/pincher/issues/1080)); `notifications/message` for extraction failures / drift warnings ([#1085](https://github.com/kwad77/pincher/issues/1085)); MCP roots/list Phase 2 background auto-index + `_meta.auto_indexed` ([#1081](https://github.com/kwad77/pincher/issues/1081) Phase 2); cross-comparator pricing harness ([#1298](https://github.com/kwad77/pincher/issues/1298)); Ansible USES_VAR produce-but-not-persist regression ([#1479](https://github.com/kwad77/pincher/issues/1479)); watcher 2s active-poll backoff after schema migration ([#1474](https://github.com/kwad77/pincher/issues/1474)). | 🚧 in flight |
