...
| **v0.26.0** | **Dashboard reliability.** Per-tab error state ([#538](https://github.com/kwad77/pincher/issues/538)), XHR abort on tab switch ([#539](https://github.com/kwad77/pincher/issues/539)), ADR length limits ([#534](https://github.com/kwad77/pincher/issues/534)), fetch error path tests ([#526](https://github.com/kwad77/pincher/issues/526)). Part of [#519](https://github.com/kwad77/pincher/issues/519). | 🚧 in flight |
