...
| **v0.16.0** | **Structural perf wins.** Closure tables for trace BFS, diff-encoded `context` responses, watcher edge-loss + IMPORTS attribution fixes ([#427](https://github.com/kwad77/pincher/issues/427), [#428](https://github.com/kwad77/pincher/issues/428)), function-typed-field call resolution ([#423](https://github.com/kwad77/pincher/issues/423)). | 🚧 in flight |
