...
| **v0.79** | **Hardening only.** Per the v0.78.1-era policy decision: the `.x9` minor is the pre-promotion stability window for each phase, NOT a feature/bug drain target. v0.79 holds only [#672](https://github.com/kwad77/pincher/issues/672) (hardening + stability sweep umbrella), [#1337](https://github.com/kwad77/pincher/issues/1337) (multi-platform install validation harness), and [#1389](https://github.com/kwad77/pincher/issues/1389) (cross-language false-positive sweep against public corpora — v1.0 gate). Features and bug fixes that surface during v0.79 go to v0.78.x patches or v0.80; feature work resumes at v0.80. | 🚧 in flight |
