...
| **v0.65** | **DOGFOOD 2 — surface every gap a real working session hits across the now-unified extraction floor.** Dashboard panel rendering on the v0.64 substrate. TS receiver-type resolver ([#1177](https://github.com/kwad77/pincher/issues/1177)). Rust + Java AST extractors ([#1182](https://github.com/kwad77/pincher/issues/1182) / [#1183](https://github.com/kwad77/pincher/issues/1183)). | 🚧 in flight |
