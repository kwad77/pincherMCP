...
| **v0.19.0** | **Receiver-type tracking + interface-dispatch precision.** Function-typed field call resolution via Go receiver-type tracking ([#423](https://github.com/kwad77/pincher/issues/423)); interface-dispatch dead_code precision via satisfaction analysis ([#493](https://github.com/kwad77/pincher/issues/493) — depends on #423); honest-savings polish — `baseline_method` stamp in `_meta` ([#477](https://github.com/kwad77/pincher/issues/477)). | 🚧 in flight |
