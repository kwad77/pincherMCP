...
| **v0.16.0** | **Structural perf wins.** Closure tables for trace BFS, diff-encoded `context` responses, persisted-deferred-edges for the full watcher fix ([#457](https://github.com/kwad77/pincher/issues/457)), function-typed-field call resolution ([#423](https://github.com/kwad77/pincher/issues/423)). | 🚧 in flight |
