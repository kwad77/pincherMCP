...
| **v0.62** | Python/Rust/Java extractors regex → AST + TS receiver-type resolver ([#1159](https://github.com/kwad77/pincher/issues/1159) / [#1177](https://github.com/kwad77/pincher/issues/1177)). | 🚧 in flight |
