...
| **v0.56.0** | **Next dogfood iteration.** Auto-reindex on binary-drift respawn ([#719](https://github.com/kwad77/pincher/issues/719)) so a swapped binary self-heals its index without a manual `force` call. Continued probe-driven hardening. | 🚧 in flight |
