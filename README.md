...
| **v0.29.0** | **Dashboard interactive polish.** Empty state CTAs ([#540](https://github.com/kwad77/pincher/issues/540)), loading skeletons ([#541](https://github.com/kwad77/pincher/issues/541)), toast notifications ([#542](https://github.com/kwad77/pincher/issues/542)), confirm dialog ([#543](https://github.com/kwad77/pincher/issues/543)), configurable refresh interval ([#552](https://github.com/kwad77/pincher/issues/552)), ADR rich render ([#553](https://github.com/kwad77/pincher/issues/553)). Part of [#519](https://github.com/kwad77/pincher/issues/519). | 🚧 in flight |
