...
| **v0.88** | **Phase 3 perf rolls + integration docs.** Python AST daemon default-flip + bench gate ([#1685](https://github.com/kwad77/pincher/issues/1685)), Swift AST extractor ([#1452](https://github.com/kwad77/pincher/issues/1452)), per-host benefits docs ([#1393](https://github.com/kwad77/pincher/issues/1393)), `pincher bench §2` ([#1298](https://github.com/kwad77/pincher/issues/1298)), hook conversion-rate field measurement ([#640](https://github.com/kwad77/pincher/issues/640)). | 🚧 in flight |
