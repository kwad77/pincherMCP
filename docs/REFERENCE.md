...
**Schema version:** v26 · **MCP tools:** 22 · **Languages detected:** ~25 (10 AST/parser-tier, 15 regex-tier, plus 7 stub-tier with no extractor — see [Language support](#language-support))
