...
| **v0.71 → v1.0** | Watch for the v0.80 stable-promotion notes — once tool schemas freeze, this section becomes the canonical answer. |
...
The MCP tool list has grown from ~15 in v0.4 to **23 in v0.70+**.
