...
- 22 MCP tools for codebase search, graph queries, and token-efficient symbol retrieval. See the main [reference](https://github.com/kwad77/pincher/blob/master/docs/reference/tools.md) for the full list.
